 ...
 *     var officers = [{name: 'officer1'}, {name: 'officer2'}];
 *
 *     // returns the current list of officers
 *     $httpBackend.whenGET('/officers').respond(officers);
 *
 *     // adds a new officer to the officers array
 *     $httpBackend.whenPOST('/officers').respond(function(method, url, data) {
 *       var officer = angular.fromJson(data);
 ...
 *     };
 *
 *     ctrl.getOfficers = function() {
 *       $http.get('/officers').then(function(response) {
 *         ctrl.officers = response.data;
 *       });
 *     };
 *
 *     ctrl.addOfficer = function(officer) {
 *       $http.post('/officers', officer).then(function() {
 *         ctrl.newOfficer = {name: ''};
 *         return ctrl.getOfficers();
 *       });
 *     };
 *
 *     ctrl.getOfficers();
 ...
 *   <form name="newOfficerForm" ng-submit="$ctrl.addOfficer($ctrl.newOfficer)">
 *     <input type="text" ng-model="$ctrl.newOfficer.name">
 *     <input type="submit" value="Add Officer">
 *   </form>
 *   <h1>Officers</h1>
 *   <ul>
 *     <li ng-repeat="officer in $ctrl.officers">{{officer.name}}</li>
 *   </ul>
 *   </div>
 * </file>
 * </example>
